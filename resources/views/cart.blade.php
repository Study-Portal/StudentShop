                    ...
                    <form class="mt-3 lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-16">
                        <section aria-labelledby="cart-heading" class="lg:col-span-7">
                            ...
                            <ul role="list" class="border-t border-b border-gray-200 divide-y divide-gray-200">
                                @foreach(Auth::user()->Cart()->get('*') as $c)
                                        ...
                                        <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                            <div>
                                                <div class="flex justify-between">
                                                    <h3 class="text-sm">
                                                        <a href="{{route('product', $c->Product->slug)}}" class="font-medium text-gray-700 hover:text-gray-800"> {{$c->Product->name}} </a>
                                                    </h3>
                                                </div>
                                                <div class="mt-1 flex text-sm">
                                                    @if ($c->Product->colour != null)
                                                        <p class="text-gray-500">{{$c->Product->colour}}</p>
                                                    @endif

                                                    @if($c->Product->size != null)
                                                        <p class="ml-4 pl-4 border-l border-gray-200 text-gray-500">{{$c->Product->size}}</p>
                                                    @endif
                                                </div>
                                                <p class="mt-1 text-sm font-medium text-gray-900">£{{$c->Product->price}}</p>
                                            </div>

                                            <div class="mt-4 sm:mt-0 sm:pr-9">
                                                <label for="quantity-0" class="sr-only">Quantity, {{$c->Product->name}}</label>
                        ...
                        <section aria-labelledby="summary-heading" class="mt-16 bg-gray-50 rounded-lg px-4 py-6 sm:p-6 lg:p-8 lg:mt-0 lg:col-span-5">
                            ...
                            <dl class="mt-6 space-y-4">
                                ...
                                <div class="border-t border-gray-200 pt-4 flex items-center justify-between">
                                    ...
                                    <dd class="text-base font-medium text-gray-900">£{{--{{\Illuminate\Support\Facades\Auth::user()->Cart()->}}--}}</dd>
                                </div>
                            </dl>
